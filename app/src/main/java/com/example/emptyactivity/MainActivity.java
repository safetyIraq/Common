...
public class MainActivity extends AppCompatActivity {
    ...
    private MaterialButton btnSetImage, btnEditProfile, btnAddPost, btnSettings;
    ...
    private void testFirebaseConnection() {
        ...
        connectedRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (connected) {
                    Toast.makeText(MainActivity.this, "✅ متصل بـ Firebase", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(MainActivity.this, "❌ غير متصل بـ Firebase", Toast.LENGTH_SHORT).show();
                }
            }
